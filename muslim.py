...
def banner():
   ...
   j  j   e       h   h   a   a  d   d
  j j     eee    h   h   a   a  dddd
  
          pppppp      r r r rr    oooo      
         p      p     r     r   o      o
         p     p      r    r   o         o
         ppppp      r r r     o          o
        p          r    r     o        o
...
def menu(my_name,my_id):
	...
	io = '''[bold cyan]
     [1] PUBLIC FRIENDS	     [6] CRACK FROM FILES
     [2] PUBLIC FRIENDS (BULK)   [7] CHECK CHECKPOINT OPTIONS
     [3] FOLLOWER	     	     [8] CHECK CRACK RESULTS
     [4] LIKES THE POST	         [9] TIPS CRACK
     [5] GROUP MEMBERS           [00] LOGOUT[bold cyan]'''
